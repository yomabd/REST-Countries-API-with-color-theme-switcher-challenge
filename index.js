...
function renderCountries(countries) {
    countryCardsContainer.innerHTML = countries.map(country => createCountryCard(country)).join('');
}
...
function handleFilter() {
    ...
    const filteredCountries = countriesData.filter(country => selectedRegion === 'all' || country.region === selectedRegion);
    renderCountries(filteredCountries);
}
